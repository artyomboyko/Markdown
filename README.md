...
Есть два варианта вставки видео в Markdown:

### Классический синтаксис Markdown
...
Особенностью данного подхода является использование тега video, превью создаётся автоматически. Код вставки следующий:

```html
<video width="320" height="240" controls>
  <source src="./video/a6337faf-38bd-45b3-9733-9ad15a10c217-mp4_720p.mp4" type="video/mp4">
</video>
```

Вставленное видео выглядит следующим образом:
